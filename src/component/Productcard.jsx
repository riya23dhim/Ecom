...
const Productcard = ({curr}) => {
  return (
    <div className='  min-w-0 flex-shrink-1 rounded-sm hover:shadow-xl hover:shadow-gray-300 hover:transform hover:scale-[1.02] shadow-md shadow-gray-300 max-md:h-80 h-92  border-1 border-gray-300 flex flex-col items-center justify-center gap-3  '>
